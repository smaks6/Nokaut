...
public class PoseUtility {
    ...
    public static void start(Player p) {
        ...
        if (Main.getInstance().getConfig().getBoolean("Team")) {
            Scoreboard scoreboard = Bukkit.getScoreboardManager().getMainScoreboard();
            Team noCollisionTeam = scoreboard.registerNewTeam(teamprefix + p.getName());
    ...
    public static void stop(Player p){
        ...
        Team team = p.getScoreboard().getTeam(teamprefix + p.getName());
        if(team != null) {
            team.unregister();
        }
    }
